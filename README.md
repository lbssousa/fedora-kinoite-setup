...
Modeled after [Omakub](https://github.com/basecamp/omakub) — one entry point, ordered modular scripts.
...
| `nvidia.sh` | RPM Fusion, akmod-nvidia, CUDA, container toolkit _(opt-in)_ |
