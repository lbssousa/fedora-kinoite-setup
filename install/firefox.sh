...
echo ""
echo "    2. Bitwarden"
echo "       https://addons.mozilla.org/en-US/firefox/addon/bitwarden-password-manager/"
echo ""
echo "    3. Dark Reader"
echo "       https://addons.mozilla.org/en-US/firefox/addon/darkreader/"
echo ""
echo "    4. Vimium-FF (or your preferred vim-keybindings extension)"
echo "       https://addons.mozilla.org/en-US/firefox/addon/vimium-ff/"
echo ""
echo "  Alternatively, a managed Firefox install can use policies.json."
echo "  See: https://mozilla.github.io/policy-templates/"
echo "------------------------------------------------------------------------"
